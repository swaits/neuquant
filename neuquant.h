...
/**
 * Wrapper function to run NeuQuant and remap an RGB image to a 16 color palette.  Uses
 ...
 */
bool NeuQuant_RGB_to_16(u8* input, unsigned int width, unsigned int height, u8* palette, u8* remapped_image, unsigned int quality=1);

/**
 * Wrapper function to run NeuQuant and remap an RGB image to a 256 color palette.  Uses
 * Palette and NeuralQuantizer classes.
 * 
 * For an example of how to use the objects, see the source for this function.
 * 
 ...
 * @return true on success; false otherwise
 */
bool NeuQuant_RGB_to_256(u8* input, unsigned int width, unsigned int height, u8* palette, u8* remapped_image, unsigned int quality=1);

/**
 * Wrapper function to run NeuQuant and remap an RGBA image to a 16 color palette.  Uses
 * Palette and NeuralQuantizer classes.
 * 
 * For an example of how to use the objects, see the source for this function.
 * 
 ...
 * @return true on success; false otherwise
 */
bool NeuQuant_RGBA_to_16(u8* input, unsigned int width, unsigned int height, u8* palette, u8* remapped_image, unsigned int quality=1);

/**
 * Wrapper function to run NeuQuant and remap an RGBA image to a 256 color palette.  Uses
 * Palette and NeuralQuantizer classes.
 * 
 * For an example of how to use the objects, see the source for this function.
 * 
 ...
 * @return true on success; false otherwise
 */
bool NeuQuant_RGBA_to_256(u8* input, unsigned int width, unsigned int height, u8* palette, u8* remapped_image, unsigned int quality=1);


/**
 * Wrapper function to run NeuQuant and remap a BGR image to a 16 color palette.  Uses
 * Palette and NeuralQuantizer classes.
 * 
 * For an example of how to use the objects, see the source for this function.
 * 
 ...
 * @return true on success; false otherwise
 */
bool NeuQuant_BGR_to_16(u8* input, unsigned int width, unsigned int height, u8* palette, u8* remapped_image, unsigned int quality=1);

/**
 * Wrapper function to run NeuQuant and remap a BGR image to a 256 color palette.  Uses
 * Palette and NeuralQuantizer classes.
 * 
 * For an example of how to use the objects, see the source for this function.
 * 
 ...
 * @return true on success; false otherwise
 */
bool NeuQuant_BGR_to_256(u8* input, unsigned int width, unsigned int height, u8* palette, u8* remapped_image, unsigned int quality=1);

/**
 * Wrapper function to run NeuQuant and remap a BGRA image to a 16 color palette.  Uses
 * Palette and NeuralQuantizer classes.
 * 
 * For an example of how to use the objects, see the source for this function.
 * 
 ...
 * @return true on success; false otherwise
 */
bool NeuQuant_BGRA_to_16(u8* input, unsigned int width, unsigned int height, u8* palette, u8* remapped_image, unsigned int quality=1);
 ...
 * @return true on success; false otherwise
 */
bool NeuQuant_BGRA_to_256(u8* input, unsigned int width, unsigned int height, u8* palette, u8* remapped_image, unsigned int quality=1);
 ...
 * A color palette.
 */
template <unsigned int NCOLORS, unsigned int NCHANNELS=3, unsigned int GREEN_CHANNEL=1>
class Palette
{
public:
	 ...
	 * @param newimage pointer to destination image (should be width*height in size)
	 */
	void ReMap(u8* image, unsigned int width, unsigned int height, u8* newimage);

private:

	unsigned int PerceptualDistance(u8* color, unsigned int entry);
	unsigned int FindClosestGreen(u8* color);
	unsigned int FindClosest(u8* color, unsigned int minentry, unsigned int maxentry);
...
public:
	 ...
	 * 
	 * @param palette reference to output palette - this is where the result goes
	 * @param quality an integer in the range [1,10], with 1 == best, and 10 == fastest
	 * 
	 * @return true on success; false otherwise
	 */
	bool Run(Palette<NCOLORS,NCHANNELS,GREEN_CHANNEL>& palette, unsigned int quality=1);
